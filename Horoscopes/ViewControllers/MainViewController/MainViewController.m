...
- (void)setupWithType:(NSUInteger)type {
    ...
    if (self.storyboard) {
        ...
        UINavigationController *navigationController = [ScreensManagerOBJC createMenuNavigationController];
        self.leftViewController = navigationController.topViewController;
